...
dataCallback:function(){
    return [//simulates incoming data
        ...
        {id:5,title:"白吃白喝‧爽‧五敵鐵金剛",count:BFG.rnd(1,800)},
        {id:6,title:"六到開‧瑪莎拉‧蒂芬妮綠",count:BFG.rnd(1,800)},
        {id:7,title:"藍莓‧七泡水‧史戈史戈",count:BFG.rnd(1,800)},
